...
public class PhysicalActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onStart() {
        ...
        MenuItem item = navigationView.getMenu().findItem(R.id.nav_physical);
